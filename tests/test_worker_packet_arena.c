...
static void test_fixed_capacity_and_recycling(void) {
  ...
  sfu_worker_release_packet(NULL, NULL, a);
  ...
  sfu_worker_release_packet(NULL, NULL, reused);
  sfu_worker_release_packet(NULL, NULL, b);
...
static void test_retained_packet_recycles_on_final_release(void) {
  ...
  sfu_worker_release_packet(NULL, NULL, pkt);
